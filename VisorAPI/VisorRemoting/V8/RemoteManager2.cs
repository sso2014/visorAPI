...
{
    public class RemoteManager2
    {
        public static List<Panel> paneles = null;
        ...
        public static void AddListPanel(List<Panel> panels)
        {
            paneles = panels;
        }
        ...
        public static void Start()
        {
            ...
            {
                //"Where"
                if (paneles[index].Id.ToString() == "P_125")
                {
                    RemoteClient remote = paneles[index].GetAccess();
                    //.................................................................
