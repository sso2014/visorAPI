...
namespace VisorRemoting.V8
{
    public class Helper
    {
        ...
        public static void UpdateObjectEquipo(DateTime dateUpdate,  string id, int presion, bool alarma_seg, int angulo, int aplicacion, bool caminando, bool esperando_pres, bool falla_electrica, bool habilitado, bool presion_nor, bool seco, bool sentido, int tension)
        {           
