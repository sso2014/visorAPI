...
namespace VisorRemoting.V1
{
    ...
    //        obj.workSocket.
    //        //StartConnect(obj);
    //        SocketAsyncEventArgs sEvent = new SocketAsyncEventArgs();
    //        sEvent.RemoteEndPoint = new IPEndPoint(IPAddress.Parse("105.1.0.125"), 10000);
    //        s.ConnectAsync(sEvent); 
    //    }
    ...
    //    //        ////obj.workSocket.ConnectAsync(ConnectAsync);
    ...
    //    //    }
    //    //}
    //    public static void Connect(SocketAsyncEventArgs e) {
    //        e.Completed += new EventHandler<SocketAsyncEventArgs>(e_Completed);
    //        System.Console.WriteLine(e.ConnectSocket.Connected.ToString());
    //    }
    ...
    //        System.Console.WriteLine(e.RemoteEndPoint.ToString());
    //    }
